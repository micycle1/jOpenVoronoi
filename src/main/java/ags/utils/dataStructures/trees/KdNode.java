...
class KdNode<T> {
	...
	// Values enter this node through addPoint/addLeafPoint as T instances and are
	// only stored in an Object[] to support leaf array resizing. Casting back to T
	// while redistributing a split leaf therefore preserves the original runtime type.
