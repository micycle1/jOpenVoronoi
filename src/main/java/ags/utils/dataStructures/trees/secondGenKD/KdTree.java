...
public abstract class KdTree<T> {
	...
	/**
	 * Construct a RTree with a given number of dimensions and a limit on maxiumum
	 * size (after which it throws away old points)
	 */
	...
	/**
	 * Remove the oldest value from the tree. Note: This cannot trim the bounds of
	 * nodes, nor empty nodes, and thus you can't expect it to perfectly preserve
