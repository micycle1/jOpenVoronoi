...
public class SvgOutput {
	...
	private void writeEdge(PrintWriter w, Edge e) {
		...
		if (e.type == EdgeType.SEPARATOR || e.type == EdgeType.LINE || e.type == EdgeType.LINESITE
				|| e.type == EdgeType.OUTEDGE || e.type == EdgeType.LINELINE || e.type == EdgeType.PARA_LINELINE) {
